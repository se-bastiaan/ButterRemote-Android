 ...
 */
package eu.se_bastiaan.popcorntimeremote.fadingactionbar;
...
public abstract class FadingActionBarHelperBase {
    ...
    private void updateHeaderHeight(int headerHeight) {
        ...
        params.height = headerHeight - PixelUtils.getPixelsFromDp(mMarginView.getContext(), 28);
        ...
        if (mListViewBackgroundView != null) {
            ...
            params2.topMargin = headerHeight - PixelUtils.getPixelsFromDp(mMarginView.getContext(), 28);
